...
public class AdminTeacherLessonsController {
    ...
    public String editLessoneFromTeacherWithNotPicked(@PathVariable("idTeach") int idTeach) {
        return "redirect:/admin/teacher/" + idTeach + "/lessons/itemNotPicked";
    }
        ...
        if (newDate.getDayOfWeek().getValue() == newTime.getDayOfTheWeek()) {
            ...
            if (lessonFinish.isBefore(time.withHour(22).withMinute(1))) {
                ...
                if (!overlap.get()) {
                    ...
                    return "redirect:/admin/teacher/" + idTeach + "/lessons/lessonOverlap";
                }
            } else {
                return "redirect:/admin/teacher/" + idTeach + "/lessons/lessonAfterAcceptedTime";
            }
        } else {
