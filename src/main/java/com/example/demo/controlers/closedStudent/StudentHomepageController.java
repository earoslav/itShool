...
public class StudentHomepageController {
    ...
    // Adds "password" and "student" to the Model; retrieves data via `studentService.getById` and `studentMapper.mapStudentToStudentDTO`.
    ...
    // Adds "output", "password", and "student" to the Model; retrieves data via `studentService.getById` and `studentMapper.mapStudentToStudentDTO`.
    ...
    // Calls `userService.checkIfExistsByEmail`, `studentService.getById`, `studentService.update`, and `studentMapper.mapStudentDTOToStudent`; returns redirects to "/student/".
