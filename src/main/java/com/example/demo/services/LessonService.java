...
public class LessonService {
    ...
    public LessonService(LessonRepository lessonRepository, LessonMapper lessonMapper, TeacherService teacherService, ObjectMapper objectMapper, TimeOfTheWeekService tswService) {
    ...
    public List<Object>  compileLessonsForStudent(Student student){
...
///////////
    ...
    public List<Object>  compileLessonsForTeacher(Teacher teacher){
        LocalDate now = LocalDate.now();
        now = now.minusWeeks(2);
        List<String> weekDaysTemp = new ArrayList<>();
        weekDaysTemp.add("ПОН");weekDaysTemp.add("ВІВТ");weekDaysTemp.add("СЕР");weekDaysTemp.add("ЧЕТ");weekDaysTemp.add("ПЯТ");weekDaysTemp.add("СУБ");weekDaysTemp.add("НЕД");
...
///////////
    ...
    public List<Object> compileLessonsForStudentInAdmin(Student student){
        LocalDate now = LocalDate.now();
        now = now.minusWeeks(2);
        List<String> weekDaysTemp = new ArrayList<>();
        weekDaysTemp.add("ПОН");weekDaysTemp.add("ВІВТ");weekDaysTemp.add("СЕР");weekDaysTemp.add("ЧЕТ");weekDaysTemp.add("ПЯТ");weekDaysTemp.add("СУБ");weekDaysTemp.add("НЕД");
